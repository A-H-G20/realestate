  ...
  <div class="container">
    ...
    <div class="slideshow-container">
        <div class="slides fade">
            <img src="img/J1.webp" alt="Photo 1">
            <p></p>
        </div> 
        <div class="slides fade">
            <img src="img/J2.jpg" alt="Photo 2">
            <p></p>
        </div>
        <div class="slides fade">
            <img src="img/J3.jpg" alt="Photo 3">
            <p></p>
        </div>
        <div class="slides fade">
            <img src="img/J5.webp" alt="Photo 4">
            <p></p>
        </div>
        <div class="slides fade">
            <img src="img/J6.webp" alt="Photo 5">
            <p></p>
        </div>
        <div class="slides fade">
            <img src="img/J7.jpg" alt="Photo 6">
            <p></p>
        </div>
        <div class="slides fade">
            <img src="img/J4.jpeg" alt="Photo 7">
            <p></p>
        </div>
    </div>
