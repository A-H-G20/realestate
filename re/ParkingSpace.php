...
<body>
    <div class="slideshow-container">
        <div class="slides fade">
            <img src="img/L1.jpg" alt="Photo 1">
        </div>
        <div class="slides fade">
            <img src="img/L2.webp" alt="Photo 2">
        </div>
        <div class="slides fade">
            <img src="img/L3.jpg" alt="Photo 3">
        </div>
        <div class="slides fade">
            <img src="img/L4.webp" alt="Photo 4">
        </div>
        <div class="slides fade">
            <img src="img/L5.webp" alt="Photo 5">
        </div>
        <div class="slides fade">
            <img src="img/L6.jpg" alt="Photo 6">
        </div>
        <div class="slides fade">
            <img src="img/L7.jpeg" alt="Photo 7">
        </div>
    </div>
