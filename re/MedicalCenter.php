...
<body>
    <div class="slideshow-container">
        <div class="slides fade">
            <img src="img/H7.jpg" alt="Photo 1">
        </div>
        <div class="slides fade">
            <img src="img/H1.webp" alt="Photo 2">
        </div>
        <div class="slides fade">

            <img src="img/H2.jpg" alt="Photo 3">
        </div>
        <div class="slides fade">
            <img src="img/H3.webp" alt="Photo 4">
        </div>
        <div class="slides fade">
            <img src="img/H4.jpg" alt="Photo 5">
        </div>
        <div class="slides fade">
            <img src="imgH5.jpg" alt="Photo 6">
        </div>
        <div class="slides fade">
            <img src="img/H6.webp" alt="Photo 7">
        </div>
    </div>
